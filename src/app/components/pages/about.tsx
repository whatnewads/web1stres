...
import { BreadcrumbNav, CTABanner } from "../shared";
  ...
  return (
    <>
      <div className="max-w-[1200px] mx-auto px-4 lg:px-6 py-12 lg:py-16">
        <BreadcrumbNav items={[{ label: "Home", to: "/" }, { label: "About Us" }]} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="rounded-xl overflow-hidden">
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1767416566975-dbf1849a1e74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwc29sYXIlMjBjb25zdHJ1Y3Rpb24lMjB3b3Jrc2l0ZXxlbnwxfHx8fDE3NzIzMDA4NzJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt="Industrial worksite with solar construction"
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={cert} className="flex items-start gap-2">
                    ...
                    <span className="text-[#5A6178]" style={{ fontSize: "14px", lineHeight: 1.6 }}>
                      {cert}
                    </span>
                  </li>
                ))}
